...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Location = System::Drawing::Point(3, 191);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(185, 182);
			...
			this->button3->Location = System::Drawing::Point(3, 379);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(185, 182);
...
private: System::Void button3_Click(System::Object^  sender, System::EventArgs^  e) {
	if (openFileDialog1->ShowDialog() == System::Windows::Forms::DialogResult::OK) {
		renderPanel->BindGL();
		renderPanel->LoadExampleImage((const char*)(System::Runtime::InteropServices::Marshal::StringToHGlobalAnsi(openFileDialog1->FileName)).ToPointer());
